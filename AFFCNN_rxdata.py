...
class multi_CNN(nn.Module):
    def __init__(self, class_mum):
        ...
        self.conv1d_b1 = nn.Sequential(
            nn.Conv1d(in_channels=2, out_channels=16, kernel_size=5, padding='same'),
            nn.BatchNorm1d(16),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_b2 = nn.Sequential(
            nn.Conv1d(in_channels=16, out_channels=64, kernel_size=7, padding='same'),
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_b3 = nn.Sequential(
            nn.Conv1d(in_channels=64, out_channels=128, kernel_size=5, padding='same'),
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_b4 = nn.Sequential(
            nn.Conv1d(in_channels=128, out_channels=256, kernel_size=7, padding='same'),
            nn.BatchNorm1d(256),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_c1 = nn.Sequential(
            nn.Conv1d(in_channels=2, out_channels=16, kernel_size=5, padding='same'),
            nn.BatchNorm1d(16),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_c2 = nn.Sequential(
            nn.Conv1d(in_channels=16, out_channels=64, kernel_size=7, padding='same'),
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_c3 = nn.Sequential(
            nn.Conv1d(in_channels=64, out_channels=128, kernel_size=5, padding='same'),
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.MaxPool1d(4),
        )
        self.conv1d_c4 = nn.Sequential(
            nn.Conv1d(in_channels=128, out_channels=256, kernel_size=7, padding='same'),
            nn.BatchNorm1d(256),
            nn.ReLU(),
            nn.MaxPool1d(4),
