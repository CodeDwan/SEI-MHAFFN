...
if __name__ == "__main__":
    ...
    model_path = './Modelsave/MHAFFN.pth'  # 模型保存path
    pic_path = False
    tsne_path = False
    noisemask_radio = 0.3
    ...
    # x_train_a, _ = datapro.noisemask(x_train_a, y_train,noisemask_radio)
    # x_test_a, _ = datapro.noisemask(x_test_a, y_test, noisemask_radio)
    ...
    # x_train_b, _ = datapro.noisemask(x_train_b, y_train, noisemask_radio)
    # x_test_b, _ = datapro.noisemask(x_test_b, y_test, noisemask_radio)
    ...
    # x_train_c, _ = datapro.noisemask(x_train_c, y_train, noisemask_radio)
    x_test_c, _ = datapro.noisemask(x_test_c, y_test, noisemask_radio)
